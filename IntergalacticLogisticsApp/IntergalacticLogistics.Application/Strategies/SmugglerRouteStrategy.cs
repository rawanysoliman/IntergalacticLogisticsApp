...
public class SmugglerRouteStrategy : IShippingCostStrategy
{
    private readonly ISwapiClient _swapiClient;
    private const decimal BaseRatePerKg = 2.0m;
    private const decimal HyperdriveExtraFee = 25.0m;

    public SmugglerRouteStrategy(ISwapiClient swapiClient)
    {
        _swapiClient = swapiClient;
    }

    public string StrategyName => "SmugglerRoute";
